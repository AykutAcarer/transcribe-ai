...
var MenuGroup = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime14.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var useLayoutEffect22 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React37.useLayoutEffect : () => {
};

// node_modules/@radix-ui/react-dropdown-menu/node_modules/@radix-ui/react-id/dist/index.mjs
var useReactId2 = React38["useId".toString()] || (() => void 0);
var count3 = 0;
function useId2(deterministicId) {
  const [id, setId] = React38.useState(useReactId2());
  useLayoutEffect22(() => {
    if (!deterministicId)
